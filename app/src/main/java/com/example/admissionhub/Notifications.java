...
public class Notifications extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intt = new Intent(Notifications.this,dashboard.class);
        ...
        {
            Intent intt = new Intent(Notifications.this,Notifications.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Notifications.this,UserStatus.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Notifications.this,userprofile.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            finish();
            Intent intt = new Intent(Notifications.this,activity_change_password.class);
            intt.putExtra("EMAIL",email);
