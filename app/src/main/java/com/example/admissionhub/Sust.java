...
public class Sust extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intt = new Intent(Sust.this,dashboard.class);
        ...
        {
            Intent intt = new Intent(Sust.this,Notifications.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Sust.this,UserStatus.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Sust.this,userprofile.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            finish();
            Intent intt = new Intent(Sust.this,activity_change_password.class);
            intt.putExtra("EMAIL",email);
