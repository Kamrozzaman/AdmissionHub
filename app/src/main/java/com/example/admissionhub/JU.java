...
public class JU extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intt = new Intent(JU.this,dashboard.class);
        ...
        {
            Intent intt = new Intent(JU.this,Notifications.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(JU.this,UserStatus.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(JU.this,userprofile.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            finish();
            Intent intt = new Intent(JU.this,activity_change_password.class);
            intt.putExtra("EMAIL",email);
