...
public class Forum extends AppCompatActivity {
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intt = new Intent(Forum.this,dashboard.class);
        ...
        {
            Intent intt = new Intent(Forum.this,Notifications.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Forum.this,UserStatus.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            Intent intt = new Intent(Forum.this,userprofile.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            finish();
            Intent intt = new Intent(Forum.this,activity_change_password.class);
            intt.putExtra("EMAIL",email);
