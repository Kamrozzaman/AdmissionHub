...
public class IUT extends AppCompatActivity {
    ...
    protected void onCreate(Bundle savedInstanceState) {
        ...
        text1.setText("02/08/2020");
        text2.setText("15/08/2020");
        text3.setText("24/08/2020");
    ...
    public boolean onOptionsItemSelected(MenuItem item)
    {
        ...
        {
            Intent intt = new Intent(IUT.this,dashboard.class);
        ...
        {
            Intent intt = new Intent(IUT.this,userprofile.class);
            intt.putExtra("EMAIL",email);
        ...
        {
            finish();
            Intent intt = new Intent(IUT.this,activity_change_password.class);
            intt.putExtra("EMAIL",email);
